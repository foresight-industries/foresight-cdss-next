...
export default function ProfilePage() {
  ...
  const [profileForm, setProfileForm] = useState({
    ...
    bio: 'Experienced PA Coordinator with 8+ years in healthcare administration and prior authorization processing.'
  });
        ...
        <div className="lg:col-span-1">
          <Card className="p-6">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{profileForm.firstName} {profileForm.lastName}</h3>
              <p className="text-sm text-muted-foreground mb-2">{profileForm.title}</p>
          ...
          <Card className="p-6 mt-6">
            <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-4">Account Summary</h4>
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">Member since</span>
                <span className="text-sm font-medium text-gray-900 dark:text-gray-100">Jan 2023</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-muted-foreground">PAs processed</span>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Select value={profileForm.timezone} onValueChange={(value) => handleProfileChange('timezone', value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
