...
import { ArrowLeft, Clock, User, Building2, Pill, FileText, AlertCircle, CheckCircle, XCircle, Download, Edit, MessageSquare, Save } from 'lucide-react';
...
export default function PADetailPage({ params }: PADetailPageProps) {
  ...
  useEffect(() => {
    ...
    if (tab && ['overview', 'clinical', 'timeline', 'documents'].includes(tab)) {
    ...
    <div className="p-6 space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)}>
        <TabsList className="grid w-full grid-cols-4 lg:w-auto lg:inline-grid">
          ...
          <TabsTrigger value="clinical">Clinical Questions</TabsTrigger>
          ...
          <div className="space-y-6 py-4">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditData({...editData, patient: {...editData.patient, phone: e.target.value}})}
                  />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="patient-gender">Gender</Label>
                  <Select value={editData.patient.gender}>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  id="patient-address"
                  value={editData.patient.address}
                  onChange={(e) => setEditData({...editData, patient: {...editData.patient, address: e.target.value}})}
                  rows={2}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="med-strength"
                    value={editData.medication.strength}
                    onChange={(e) => setEditData({...editData, medication: {...editData.medication, strength: e.target.value}})}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    id="med-quantity"
                    value={editData.medication.quantity}
                    onChange={(e) => setEditData({...editData, medication: {...editData.medication, quantity: e.target.value}})}
                  />
                </div>
              </div>
              <div className="space-y-2">
                <Label htmlFor="med-dosage">Dosage Instructions</Label>
                <Textarea
                  id="med-dosage"
                  value={editData.medication.dosage}
                  onChange={(e) => setEditData({...editData, medication: {...editData.medication, dosage: e.target.value}})}
                  rows={2}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h4 className="font-medium text-sm text-muted-foreground">Provider Information</h4>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="provider-name">Provider Name</Label>
                  <Input
                    id="provider-name"
                    value={editData.provider.name}
                    onChange={(e) => setEditData({...editData, provider: {...editData.provider, name: e.target.value}})}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    id="provider-npi"
                    value={editData.provider.npi}
                    onChange={(e) => setEditData({...editData, provider: {...editData.provider, npi: e.target.value}})}
                  />
                </div>
              </div>
            </div>
