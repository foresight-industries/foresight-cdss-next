...
export class ConfigStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: ConfigStackProps) {
    ...
    const hipaaRules = this.createHIPAAComplianceRules();
  ...
  private createHIPAAComplianceRules(): Construct[] {
    return [
  ...
  private createHealthcareComplianceRules(): Construct[] {
    return [
  ...
  private createCodeSigningCheckFunction(): cdk.aws_lambda.Function {
    // NOTE: This function intentionally does NOT use code signing to avoid circular dependency
    // It monitors code signing compliance for OTHER Lambda functions
